...
class ContactFormTest {
  ...
  void guestCanSubmitContactForm(Page page) {
    new HomePage(page).open().assertLoaded();
        ...
        page.waitForResponse(
            ...
            () -> {
              form.fill(
                  ...
                  "This message was submitted through the UI by the opt-in portfolio automation"
                      + " suite.");
              form.submit();
            });
