// @ts-nocheck
import type * as __TypedOpenapi from "./runner-api.types.js";
...
// <Endpoints>
export type get_ListRuns = __TypedOpenapi.Endpoints.get_ListRuns;
export const get_ListRuns = {
  method: z.literal("GET"),
  path: z.literal("/api/v1/runs"),
  requestFormat: z.literal("json"),
  responseFormat: z.literal("json"),
  parameters: z.never(),
  responses: { 200: z.array(RunResponse), 500: ProblemDetail },
};

export type post_CreateRun = __TypedOpenapi.Endpoints.post_CreateRun;
export const post_CreateRun = {
  method: z.literal("POST"),
  path: z.literal("/api/v1/runs"),
  requestFormat: z.literal("json"),
  responseFormat: z.literal("json"),
  parameters: { body: CreateRunRequest },
  responses: { 202: RunResponse, 400: ProblemDetail, 500: ProblemDetail, 503: ProblemDetail },
};

export type post_CancelRun = __TypedOpenapi.Endpoints.post_CancelRun;
export const post_CancelRun = {
  method: z.literal("POST"),
  path: z.literal("/api/v1/runs/{runId}/cancel"),
  requestFormat: z.literal("json"),
  responseFormat: z.literal("json"),
...
export const get_GetRun = {
  method: z.literal("GET"),
  path: z.literal("/api/v1/runs/{runId}"),
  requestFormat: z.literal("json"),
  responseFormat: z.literal("json"),
  parameters: { path: z.object({ runId: z.string() }).strict() },
  responses: { 200: RunResponse, 404: ProblemDetail, 500: ProblemDetail },
};

export type get_DownloadRunLog = __TypedOpenapi.Endpoints.get_DownloadRunLog;
export const get_DownloadRunLog = {
  method: z.literal("GET"),
  path: z.literal("/api/v1/runs/{runId}/log"),
  requestFormat: z.literal("json"),
  responseFormat: z.literal("json"),
  parameters: { path: z.object({ runId: z.string() }).strict() },
...
export const get_GetRunnerCapabilities = {
  method: z.literal("GET"),
  path: z.literal("/api/v1/capabilities"),
  requestFormat: z.literal("json"),
  responseFormat: z.literal("json"),
  parameters: z.never(),
  responses: { 200: CapabilitiesResponse, 500: ProblemDetail },
};
...
post: {
           "/api/v1/runs": post_CreateRun,
"/api/v1/runs/{runId}/cancel": post_CancelRun
         }
